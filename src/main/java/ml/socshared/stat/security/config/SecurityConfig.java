package ml.socshared.stat.security.config;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import ml.socshared.stat.config.Constants;
import ml.socshared.stat.security.jwt.JwtAuthenticationEntryPoint;
import ml.socshared.stat.security.jwt.JwtConfigurer;
...
import static ml.socshared.stat.config.Constants.LOCAL_PROFILE;
